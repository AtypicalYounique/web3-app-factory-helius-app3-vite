...
const BANK = [
  ...
  { id:"b1", topic:"company", level:"beginner",
    ...
    options:["A multi-chain bridge","Solana-native RPC, APIs, and real-time data infrastructure","An Ethereum L2 rollup","A liquid staking token"],
    answer:1,
  ...
  { id:"b3", topic:"solana-rpc", level:"beginner",
    ...
    options:["Mints new tokens","Validates blocks for the network","Lets the app read state and submit transactions","Stores private keys"],
    answer:2,
  ...
  { id:"b4", topic:"streaming", level:"beginner",
    ...
    options:["A scheduled cron job","A push notification of on-chain events to a URL you control","A way to mint NFTs","A type of staking reward"],
    answer:1,
  ...
  { id:"b5", topic:"mev-fees", level:"beginner",
    ...
    options:["Paying validators to skip your transaction","Increasing the chance your transaction lands during congestion","Buying NFTs faster","Reducing your wallet's gas balance"],
    answer:1,
  ...
  { id:"b7", topic:"solana-rpc", level:"beginner",
    ...
    options:["The transaction reaching a blockchain explorer","The transaction being included in a confirmed block","The transaction being sent from a wallet","The transaction being signed"],
    answer:1,
  ...
  { id:"b8", topic:"market", level:"beginner",
    ...
    options:["Only retail wallet users","dApps, wallets, trading firms, NFT projects, DeFi protocols","Only validators","Only block explorers"],
    answer:1,
  ...
  { id:"b9", topic:"streaming", level:"beginner",
    ...
    options:["A wallet UI framework","A high-performance push protocol for streaming Solana state","A token standard","An NFT royalty scheme"],
    answer:1,
  ...
  { id:"b10", topic:"company", level:"beginner",
    ...
    options:["Run validators","Work with Digital Asset Standard data (NFTs, tokens) on Solana","Bridge tokens to Ethereum","Issue stablecoins"],
    answer:1,
  ...
  { id:"b11", topic:"ops", level:"beginner",
    ...
    options:["To avoid taxes","Because RPC latency varies a lot by user location","Because it's required by Solana protocol","Because it lowers token price"],
    answer:1,
  ...
  { id:"b12", topic:"mev-fees", level:"beginner",
    ...
    options:["A WebSocket that requires KYC","A send path that uses staked validators for higher landing reliability","A way to lock tokens","An NFT type"],
    answer:1,
  ...
  { id:"i1", topic:"company", level:"intermediate",
    ...
    options:["DAS API","LaserStream","Priority Fee API","Webhooks"],
    answer:1,
  ...
  { id:"i3", topic:"solana-rpc", level:"intermediate",
    ...
    options:["getSlot","getProgramAccounts","getRecentBlockhash","getHealth"],
    answer:1,
  ...
  { id:"i4", topic:"streaming", level:"intermediate",
    ...
    options:["Geyser/gRPC stream","Provider-grade enhanced WebSockets","Default public Solana WebSockets","Webhooks"],
    answer:2,
  ...
  { id:"i5", topic:"mev-fees", level:"intermediate",
    ...
    options:["To reduce wallet popups","Because fee competition depends on the accounts and programs the txn touches","Because it's required by Solana","To make NFTs cheaper"],
    answer:1,
  ...
  { id:"i6", topic:"company", level:"intermediate",
    ...
    options:["Hobby","Developer","Maker","Hacker"],
    answer:1,
  ...
  { id:"i8", topic:"ops", level:"intermediate",
    ...
    options:["Inflation","User-visible tail latency and a single failure point","Token unlocks","Regulatory exposure"],
    answer:1,
  ...
  { id:"i9", topic:"streaming", level:"intermediate",
    ...
    options:["They use less bandwidth on average and only fire on real events","They are subsidized by validators","They use a different protocol with cheaper fees","They skip the network"],
    answer:0,
  ...
  { id:"i10", topic:"market", level:"intermediate",
    ...
    options:["DEX engineering team","NFT marketplace ops","Trading firm market maker","On-chain protocol governance voter"],
    answer:3,
  ...
  { id:"i11", topic:"company", level:"intermediate",
    ...
    options:["A different L2","WebSocket subscriptions powered by the LaserStream backend with redundancy","A non-Solana protocol","A wallet feature"],
    answer:1,
  ...
  { id:"i12", topic:"ops", level:"intermediate",
    ...
    options:["They don't use storage","Solana ledger growth is high and archive history is large","They are forbidden by protocol","They use special hardware mandated by Solana Foundation"],
    answer:1,
  ...
  { id:"e1", topic:"streaming", level:"expert",
    ...
    options:["JSON-RPC polling","Default WebSockets","gRPC / Geyser","HTTP long polling"],
    answer:2,
  ...
  { id:"e2", topic:"mev-fees", level:"expert",
    ...
    options:["The network is empty","The network is congested and txn order matters","Only on devnet","Never; one alone is enough"],
    answer:1,
  ...
  { id:"e3", topic:"ops", level:"expert",
    ...
    options:["GPU FLOPS","Single-thread CPU frequency and NVMe IOPS","RAM ECC","USB throughput"],
    answer:1,
  ...
  { id:"e4", topic:"streaming", level:"expert",
    ...
    options:["It eliminates reorgs","It lets a consumer reconnect and resume from a slot rather than orchestrating complex backfills","It makes the API free","It removes the need for retries"],
    answer:1,
  ...
  { id:"e5", topic:"market", level:"expert",
    ...
    options:["Random ad-hoc scripts","Repeatable, high-throughput, latency-sensitive production traffic","Hobby projects","Marketing landing pages"],
    answer:1,
  ...
  { id:"e6", topic:"company", level:"expert",
    ...
    options:["DAS API + Webhooks","Priority Fee API + staked connections","Token Mint API + Bridges","Validator Client + Stake Pool"],
    answer:1,
  ...
  { id:"e7", topic:"ops", level:"expert",
    ...
    options:["Branding","To isolate failure modes and tune capacity per request class","Because Solana requires it","To avoid taxes"],
    answer:1,
  ...
  { id:"e8", topic:"streaming", level:"expert",
    ...
    options:["Lower fees","Portability between providers and validators","Mandatory KYC","Built-in MEV"],
    answer:1,
  ...
  { id:"e9", topic:"mev-fees", level:"expert",
    ...
    options:["Slightly slower analytics dashboards","Missed fills, stale quotes, and slippage during volatility","Smaller marketing reach","UI bugs"],
    answer:1,
  ...
  { id:"e10", topic:"company", level:"expert",
    ...
    options:["One server backed by one node","Each region has multiple LaserStream servers backed by multiple Solana nodes","No redundancy","Cross-chain replication"],
    answer:1,
  ...
  { id:"e11", topic:"ops", level:"expert",
    ...
    options:["Validator vote weight","NVMe throughput and network bandwidth","NFT royalties","Token supply"],
    answer:1,
  ...
  { id:"e12", topic:"market", level:"expert",
    ...
    options:["Repeated landing failures during congestion","Cheap headline price with no SLA or staked send path","Need for dedicated streaming capacity","Region coverage gaps"],
    answer:1,
